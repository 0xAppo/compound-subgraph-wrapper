...
let loggerTransport = new winston_1.default.transports.Console({
    format: winston_1.default.format.combine(
        ...
        winston_1.default.format.printf(args => {
...
const createSchema = () =>
    __awaiter(void 0, void 0, void 0, function*() {
        ...
        const subscriptionClient = new subscriptions_transport_ws_1.SubscriptionClient(
  ...
  `
        ...
        const borrowBalanceUnderlying = cToken => bignum(cToken.storedBorrowBalance)
        ...
        const totalCollateralValueInEth = account =>
            account.___tokens.reduce(
                (acc, token) => acc.plus(tokenInEth(token.market).times(token.cTokenBalance)),
                bignum('0'),
            )
        const totalBorrowValueInEth = account =>
            !account.hasBorrowed
                ? bignum('0')
                : account.___tokens.reduce(
                      (acc, token) =>
                          acc.plus(bignum(token.market.underlyingPrice).times(borrowBalanceUnderlying(token))),
                      bignum('0'),
                  )
...
const rejectBadHeaders = (req, res, next) =>
    __awaiter(void 0, void 0, void 0, function*() {
        if (
...
const run = () =>
    __awaiter(void 0, void 0, void 0, function*() {
        ...
        app.use(
            express_winston_1.default.errorLogger({
                transports: [loggerTransport],
                baseMeta: { component: 'Server' },
            }),
        )
